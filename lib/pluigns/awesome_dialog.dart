          ...
          AnimatedButton(
            pressEvent: () {
              AwesomeDialog(
                ...
                title: 'INFO',
                desc:
                    'desc Master as evermore the was agreeing burning something, and soon this ghastly tossed tapping throws bust be nevermore, whom tapping get only all presently unbrokenquit i token. My the nothing. ',
                showCloseIcon: true,
                btnCancelOnPress: () {},
                btnOkOnPress: () {},
              ).show();
