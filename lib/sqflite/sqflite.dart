...
class SqlDb {
  ...
  intialDB() async {
    ...
    // Open the database using the FFI factory
    DatabaseFactory dbFactory = databaseFactoryFfi;
    Database mydb = await dbFactory.openDatabase(path,
...
// sqflite ===>> for android , ios and macos
  // intialDB() async {
  //   // Get a location using getDatabasesPath
  //   String dataBasePath = await getDatabasesPath();
  //   String path = join(dataBasePath, "test.db");
